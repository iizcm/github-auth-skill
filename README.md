...
[![Category: Github](https://img.shields.io/badge/Category-Github-purple)](#)
...
cp -r github/github-auth ~/.hermes/skills/github/github-auth/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/github-auth-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/github-auth-skill.git ~/.hermes/skills/github/github-auth/
```
...
```text
skill_view(name="github/github-auth")
```
...
```text
Use the github auth skill to <describe your specific task here>
```
...
```text
Gunakan skill github auth untuk <deskripsikan tugas spesifik Anda di sini>
```
